...
def execute_rdrcode(params, rdrCode_input_fnames):
    ...
    for inp_name in rdrCode_input_fnames:
        ...
        os.chdir(sar_dir)
        os.system('/home/anurag/Documents/PhDProject/doris/bin/doris.rmstep.sh comp_refdem ifgs.res')
        cmd = 'doris '+ inp_name
        os.system(cmd)
        #os.chdir(code_dir)
...
def conv_raw(dates, master_date, doris_stack_dir):
    for date in dates:
        ...
        os.system(cp_cmd)
        #alter ifgs file
        os.system('/home/anurag/Documents/PhDProject/doris/bin/doris.rmstep.sh comp_refdem '+os.path.join(doris_stack_dir, date, 'swath_1', 'burst_1', 'ifgs.res'))
        #alter input filek
