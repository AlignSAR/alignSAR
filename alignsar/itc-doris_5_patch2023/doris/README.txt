...
doris_users@tudelft.nl. https://github.com/TUDelftGeodesy/Doris


2023

An updated version of Doris 5 (created by Anurag Kulshrestha and Ling Chang, Institute: Department of Earth Observation Science, ITC, University of Twente. The Netherlands)
Changes:
...
Changes in bk messages.hh: change Line 214 strcat(name ,’\0’); to name [9] = ’\0’
Changes in cpxfiddle.cc: change if (argv[optind]==’\0’) to if (*argv[optind]==’\0’)
