...
if __name__=='__main__':
    #doris_stack_dir_VV = '/media/xu/Elements3/AlignSAR/Doris_Processing/Doris_Processing_36_Groningen/new_datastack/stack_vv/'
    #doris_stack_dir_VH = '/media/xu/Elements3/AlignSAR/Doris_Processing/Doris_Processing_36_Groningen/new_datastack/stack_vh/'
