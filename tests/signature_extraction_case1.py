...
if __name__=='__main__':
    doris_stack_dir_VV = os.path.abspath("./stack_vv/")
    doris_stack_dir_VH = os.path.abspath("./stack_vh/")
    ...
    # read geo lon lat
    lam_dataFilename = os.path.abspath("./stack_vv/lam.raw")
    phi_dataFilename = os.path.abspath("./stack_vv/phi.raw")
