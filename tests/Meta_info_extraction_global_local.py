...
def get_global_attribute(sar_folder_path, folder_num, xml_num):
    ...
    sar_processing_software = "doris 5"
...
Cross_pol_correlation_coefficient_attr={
    ...
    'Reference': 'Lee, J.S.; Pottier, E. Polarimetric Radar Imaging: From Basics to Applications; CRC Press: Boca Raton, FL, USA, 2017. https://doi.org/10.1201/9781420054989.'
}
