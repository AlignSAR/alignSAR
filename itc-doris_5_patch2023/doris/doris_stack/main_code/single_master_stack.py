...
class SingleMaster(object):
    ...
    def resample(self, type='', concatenate=False, ras=False, overwrite=False):
        ...
        if concatenate == True:
            ...
            self.concatenate(rsmp_name, rsmp_name, dt=np.dtype('complex64'), overwrite=overwrite, master=True)
    ...
    def fake_master_resample(self):
        ...
        rsmp_name = 'slave_rsmp.raw'
        self.concatenate('master', rsmp_name, dt=np.dtype('complex64'), overwrite=True)
